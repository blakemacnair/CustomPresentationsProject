#
#  Be sure to run `pod spec lint CustomPresentations.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/blakemacnair/CustomPresentationsProject.git", :tag => "v" + "#{s.version}", :branch => "master" }
